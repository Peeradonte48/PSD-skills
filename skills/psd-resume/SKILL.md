...
Orchestrator role: short-circuit trivial cases, dispatch `psd-resumer` only when needed, surface its summary verbatim.
</objective>
...
2. **Otherwise dispatch `psd-resumer`**. The agent reads STATE/CHECKPOINT/active-artifact and reports.
